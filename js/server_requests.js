...
function sendTweetToDB(tweet, good){
  var xmlhttp;
    ...
    var json_data= {"wordID":wordID, "tweetID":tweet.TweetID, "tweetText":tweet.Text, "userID":userID, "gameMode":game, "language":language, "tweetAuthor":tweet.Author, "good" : good    }
