			...
			<div id="game" ng-app>
				...
				<div id="gamezone3" ng-controller="InlineEditorController" ng-click="hideTooltip();">
					<div id="gamezone-main3" >
						<div id="entry">
							<p id="instructions">Check the tweets that are excellent examples of this meaning:  </p>
							<p id="word3"></p>		
							<p id="pos3"></p>					
							<p id="def3"></p>
							<div id="definitions_wrapper">
					...
					<div id="gamezone-footer3">
						...
						<div id="footer-next3">
							<img title="Next" id="next1" ng-click="clear($event)" class="control" src="media/rightarrow.png" onclick="submitTweets(); setTimeout(get_randomForTweets, 500); publishStory();">
						</div>
					</div>
				</div>
				</div>
