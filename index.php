	...
	<div id="main" >
		<div id="portal">
			...
			<div id="gamezone4" ng-controller="InlineEditorController" ng-click="hideTooltip();">
				...
				<div id="footer-next3">
					<img title="Next" id="next1" ng-click="clear($event)" class="control" src="media/rightarrow.png" onclick='submitCheckBoxData("game4"); setTimeout(sendGame4SentenceToDB(), 500);'>
				</div>
			</div>
