...
$implementedGames= array('1' => array(1), '2' => array(2,3), '3' => array(1), '4' => array(4));
...
<div id="info3">
			<div id="info3-main">
				<div class="bla">
<p><h1><strong><?php echo _('Examples Games (Tweets and Sentences)'); ?></strong> </h1><br />
...
<p><?php echo _('Usage examples help people understand how a term is really used. Finding a good example can be hard, however.'); ?></p>
<ul>
  <li><?php echo _('Bad: "Your eyes are blue."'); ?></li>
  <li><?php echo _('Good: "Your eyes are the same blue as the water in the bay, and sparkle even more in the sunlight."'); ?></li>
</ul>
<p><?php echo _('Because words have different senses, an example might be excellent in one context but completely wrong in another.'); ?></p>
<ul>
  <li><?php echo _('Good example for a different meaning of'); ?> <strong><em><?php echo _('blue'); ?></em></strong>: <?php echo _('"My heart is aching from the pain of missing you, I am feeling so blue."'); ?></li>
</ul>
<p><?php echo _('In the Examples games, your goal is to find sentences that are real gems for a specific meaning of a term. The Tweet game shows you a bunch of recent postings to Twitter, while the Sentences game grabs examples from other sources. You read the definition, and click on the tweets or sentences that will be a great help for dictionary users to understand the exact meaning we show.'); ?></p>
<ul>
  <li><?php echo _('Do NOT click on an entry if it is a good example of a'); ?> <em><?php echo _('different'); ?></em> <?php echo _('meaning'); ?>.</li>
  <li><?php echo _('Do NOT click on an entry if it kind-of, sort-of works with the meaning in question.'); ?></li>
  <li><?php echo _('ONLY click on an entry if it'); ?> <strong><em><?php echo _('perfectly demonstrates'); ?></em></strong> <?php echo _('the meaning'); ?> <strong><font color="#EBA634"><?php echo _('written in orange'); ?></font></strong>.</li>
</ul>
