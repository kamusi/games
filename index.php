...
<ul type="disc">
  ...
  <li><?php echo _("No circles: Definitions should NOT contain the word that is being defined, nor its close relatives."); ?> <em><?php echo _("Happiness"); ?></em> <?php echo _(' is "A feeling of, not "The feeling of being happy." Definitions should not be circular - we cannot now say); ?> <em><?php echo _('joy'); ?></em> <?php echo _('is "A feeling of happiness."); ?></li>
