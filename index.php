					...
					<div id="gamezone-main1" >
						...
						<div id="definitions_wrapper">
							<div class="input_tool" ng-click="$event.stopPropagation()" ng-show="showtooltip">
								...
								<img title="Submit" id="SubmitDef" ng-click="clear($event)" class="controlSmall" src="media/rightarrowSmall.png" onclick="playClick(); $scope.hideTooltip(); vote();get_ranked();">
